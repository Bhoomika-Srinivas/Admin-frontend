...
export const mockEvents: Event[] = [
  { id: '1', title: 'Synergy 2024 - Annual Technical Fest', date: '2026-04-20', time: '09:00', venue: 'BIET Main Campus', description: 'Annual technical and cultural fest with competitions, workshops and seminars.', images: [], pinned: true, level: 'institutional', department: '', status: 'upcoming', approvalStatus: 'approved', createdBy: '1', createdAt: '2024-02-01T00:00:00Z' },
  { id: '2', title: 'Industry Expert Workshop on Cloud Computing', date: '2026-04-15', time: '10:00', venue: 'Seminar Hall A', description: 'Hands-on workshop by industry experts from AWS and Google Cloud.', images: [], pinned: false, level: 'department', department: 'CSE', status: 'upcoming', approvalStatus: 'pending', createdBy: '2', createdAt: '2024-02-10T00:00:00Z' },
  { id: '3', title: 'Alumni Meet 2024', date: '2026-05-30', time: '11:00', venue: 'College Auditorium', description: 'Annual alumni gathering to reconnect and network.', images: [], pinned: false, level: 'institutional', department: '', status: 'upcoming', approvalStatus: 'approved', createdBy: '1', createdAt: '2024-02-05T00:00:00Z' },
  { id: '4', title: 'Inter-College Sports Tournament', date: '2024-03-10', time: '08:00', venue: 'BIET Sports Complex', description: 'Annual inter-college sports tournament featuring cricket, football and more.', images: [], pinned: false, level: 'institutional', department: '', status: 'upcoming', approvalStatus: 'approved', createdBy: '1', createdAt: '2024-02-15T00:00:00Z' },
  { id: '5', title: 'IEEE Student Chapter Workshop', date: '2024-02-25', time: '10:00', venue: 'ECE Lab', description: 'IEEE workshop on embedded systems and IoT applications.', images: [], pinned: false, level: 'department', department: 'ECE', status: 'upcoming', approvalStatus: 'approved', createdBy: '1', createdAt: '2024-01-20T00:00:00Z' },
  { id: '6', title: 'ECE Department Tech Talk', date: '2026-04-10', time: '14:00', venue: 'ECE Seminar Hall', description: 'Guest lecture on VLSI design trends.', images: [], pinned: false, level: 'department', department: 'ECE', status: 'upcoming', approvalStatus: 'pending', createdBy: '3', createdAt: '2024-02-20T00:00:00Z' },
]
