...
export default function DeptCatalogProgramListPage() {
  ...
  // Derive unique programs from batches
  ...
  function handleNavigate(prog: string) {
    navigate(`/departments/${deptId}/academics/courses/${programType}/${encodeURIComponent(prog)}`)
  }
    ...
    <div className="space-y-5">
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title="Add Program">
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-400">This will take you to the semester view where you can add batches and courses.</p>
        </div>
        <ModalFooter>
