  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-display font-bold text-slate-800">Timeline / History</h2>
          <p className="text-sm text-slate-500 mt-0.5">{entries.length} entries • Key milestones in alumni association history</p>
        </div>
