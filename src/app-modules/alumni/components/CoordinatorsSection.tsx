...
const roleBadgeVariant: Record<CoordinatorRole, 'green' | 'blue' | 'yellow' | 'red'> = {
  DEAN: 'yellow',
  COORDINATOR: 'green',
}
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-base font-semibold text-slate-800">Dean & Coordinators</h3>
          <p className="text-xs text-slate-500 mt-0.5">{filtered.length} coordinators</p>
        </div>
