...
// Verified default data
const defaultMembers: Omit<ExecutiveCommitteeMember, 'id'>[] = [
  { name: 'Dr H B Aravind', roleType: 'PRESIDENT', designation: 'President', order: 1 },
  { name: 'M.C. Patel', roleType: 'SECRETARY', designation: 'Secretary', order: 2 },
  { name: 'Dr K C Devendrappa', roleType: 'TREASURER', designation: 'Treasurer', order: 3 },
]
  ...
  async function seedDefaultData() {
    try {
      for (const member of defaultMembers) {
        await alumniService.createCommitteeMember(member)
      }
      await reload()
      toast.success('Default committee members added')
    } catch {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-base font-semibold text-slate-800">Executive Committee</h3>
