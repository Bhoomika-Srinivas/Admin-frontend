...
// Verified default events
const defaultEvents: Omit<AlumniEvent, 'id' | 'createdAt'>[] = [
  {
    title: '2009 Alumni Meet',
    date: '2009-12-15',
    time: '10:00',
    department: 'CSE',
    location: 'BIET Campus',
    description: 'First major alumni meet organized by B.T. Achyutha',
    status: 'published',
  },
  {
    title: 'Mega Alumni Meet 2010',
    date: '2010-12-20',
    time: '11:00',
    department: 'ECE',
    location: 'College Auditorium',
    description: 'Grand alumni gathering led by M.C. Patel',
    status: 'published',
  },
  {
    title: 'Textile Alumni Meet 2012',
    date: '2012-01-15',
    time: '09:30',
    department: 'TEXTILE',
    location: 'Textile Block',
    description: 'Global participation in Textile department alumni meet',
    status: 'published',
  },
]
  ...
  async function seedDefaultData() {
    try {
      for (const event of defaultEvents) {
        await alumniService.createEvent(event)
      }
      await reload()
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-base font-semibold text-slate-800">Alumni Events</h3>
