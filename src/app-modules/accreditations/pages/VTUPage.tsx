...
export default function VTUPage() {
  ...
  const { data, loading, error, reload } = useAccreditations({ type: 'VTU' })
      ...
      <div className="space-y-5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-display font-bold text-slate-800">VTU</h2>
            <p className="text-sm text-slate-500">Visvesvaraya Technological University — Letters of Affiliation</p>
          </div>
