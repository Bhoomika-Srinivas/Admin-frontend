...
export default function NIRFPage() {
  ...
  const { data, loading, error, reload } = useAccreditations({ type: 'NIRF' })
      ...
      <div className="space-y-5">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-display font-bold text-slate-800">NIRF</h2>
            <p className="text-sm text-slate-500">National Institutional Ranking Framework</p>
          </div>
